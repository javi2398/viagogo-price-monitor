...
def main(urlEvento, precioMaximo, discordWebhook):
    ...
    while True:
        try:
            ...
            # Peticion que nos devuelve los precios del evento
            headers = {
                'accept': '*/*',
                'accept-language': 'es-419,es;q=0.9',
            ...
            json_data = {
                ...
                'EventId': urlEvento.split('E-')[1].split('?')[0],
            ...
            if response.status_code != 200:
                ...
                delay += 1 # Vamos aumentando para hallar el delay perfecto donde no banee
